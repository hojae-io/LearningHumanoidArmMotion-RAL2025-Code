...
import extensions.cartpole.mdp as brl_mdp

##
# Pre-defined configs
##
from extensions.cartpole.assets import CARTPOLE_CFG  # isort: skip
...
class EventsCfg:
    ...
    reset_robot_joints = EventTerm(
        ...
        mode="reset",
        params={
            "position_range": torch.tensor([[-2.5, 2.5], # slider_to_cart
                                            [-torch.pi, torch.pi], # cart_to_pole
                                            ]),
            "velocity_range": torch.tensor([[-1., 1.], # slider_to_cart
                                            [-1., 1.], # cart_to_pole
                                            ]),
        },
    )
...
class RewardsCfg:
    ...
    class CartpoleRewardsCfg:
        """Reward terms for the cartpole actor-critic."""
    ...
    cartpole: CartpoleRewardsCfg = CartpoleRewardsCfg()
