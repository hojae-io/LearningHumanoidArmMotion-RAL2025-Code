...
class RewardsCfg:
    ...
    class LegRewardsCfg:
        ...
        # * Arm rewards * #
        # arm_joint_regularization = RewTerm(
        #     func=brl_mdp.arm_joint_regularization_penalty,
        #     weight=1.,
        #     params={"asset_cfg": SceneEntityCfg("robot")}
        # )
...
@configclass
class HumanoidFullVanillaEnvCfg(ManagerBasedRLEnvCfg):
    ...
    if DEPLOYMENT_TRAINING:
        ...
        scene.robot.init_state.joint_pos = {'a01_right_hip_yaw':        0.,       'a06_left_hip_yaw':        0.,
                                            ...
                                            'a14_right_elbow':          0.,       'a18_left_elbow':          0.
                                            }
    else:
...
@configclass
class HumanoidFullVanillaEnvCfg_PLAY(HumanoidFullVanillaEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
